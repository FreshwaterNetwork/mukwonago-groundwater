...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, lang ) {
	return declare(PluginBase, {
		...
		toolbarName: "Mukwonago groundwater", showServiceLayersInLegend: true, allowIdentifyWhenActive: false, rendered: false, resizable: false,
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "http://cirrus-web-adapter-241060755.us-west-1.elb.amazonaws.com/arcgis/rest/services/FN_Wisconsin/dataForWiMukApp_112018/MapServer";
			this.layerDefs = [];
		},
